        ...
        <div className="flex items-start justify-between gap-4 sm:items-center sm:justify-start sm:gap-4">
          ...
          <div className="hidden sm:block flex-1 text-center">
            ...
            <div className="mt-1 flex gap-2 text-sm justify-center">
              <span className="px-2 py-0.5 rounded-md text-xs font-medium bg-rose-50 dark:bg-rose-500/10 text-rose-700 dark:text-rose-400 border border-rose-200 dark:border-rose-500/30">
                Role: Super Admin
              </span>
          ...
          <div className="flex flex-col items-end gap-1 sm:hidden">
            <span className="px-2 py-0.5 rounded-md text-[11px] font-medium bg-rose-50 dark:bg-rose-500/10 text-rose-700 dark:text-rose-400 border border-rose-200 dark:border-rose-500/30">
              Role: Super Admin
            </span>
...
function Info({ label, value }) {
  return (
    <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-3">
      ...
      <p className="font-medium break-words text-gray-900 dark:text-slate-100">{value}</p>
    </div>
  );
}
