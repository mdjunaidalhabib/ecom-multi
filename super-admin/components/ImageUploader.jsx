  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <label className="block text-sm font-medium text-gray-700 dark:text-slate-300">
        {label}
        <span className="text-[11px] text-gray-500 dark:text-slate-500 font-semibold ml-2">
      ...
      <div
        ...
        className={`
          ...
          ${error ? "border-red-500 dark:border-red-500/60 bg-red-50 dark:bg-red-500/10" : "border-gray-300 dark:border-slate-600 hover:border-rose-400 dark:hover:border-rose-500"}
