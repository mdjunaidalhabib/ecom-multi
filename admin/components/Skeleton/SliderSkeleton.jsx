  ...
  return (
    <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-stretch">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-xl p-3 shadow-sm flex flex-col h-full animate-pulse"
        >
          {/* ✅ image skeleton (1500x500 ratio) */}
          <div className="aspect-[3/1] bg-gray-200 dark:bg-slate-700 rounded-lg" />
