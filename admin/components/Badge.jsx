export default function Badge({ children, type }) {
  ...
  const colors = {
    ...
    confirmed: "border-blue-200 dark:border-blue-500/20 text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10",
    shipped: "border-purple-200 dark:border-purple-500/20 text-purple-700 dark:text-purple-400 bg-purple-50 dark:bg-purple-500/10",
