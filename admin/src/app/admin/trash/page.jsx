  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-3 mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-slate-100">🗑️ Trash</h1>
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-500 dark:text-slate-400 py-10">Trash is empty.</div>
      )}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-slate-900 rounded-xl p-6 w-full max-w-sm shadow-xl border dark:border-slate-700 animate-[zoomIn_.2s_ease-out]">
              {confirmModal.mode === "restore" && (
                <>
                  <h2 className="text-xl font-bold text-green-600 dark:text-green-400 mb-3">
                    ♻️ Restore Item
                  </h2>
